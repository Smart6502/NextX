...
class HelpCog(commands.Cog):
    ...
    async def help(self, ctx):
        if ctx.invoked_subcommand is None:
            ...
            hembed.add_field(name="**Moderation**", value="`$help moderator`", inline=True)
            hembed.add_field(name="**Levels**", value="`$help levels`", inline=True)
            hembed.add_field(name="**Search**", value="`$help search`", inline=True)
            hembed.add_field(name="**Music**", value="`$help music`", inline=True)
            hembed.add_field(name="**Misc**", value="`$help misc`", inline=True)
    ...
    async def search(self, ctx):
        ...
        hembed.add_field(name="`$ysearch [content]`", value="Searches Youtube for you.", inline=False)
        await ctx.send(embed=hembed)
    ...
    async def music(self, ctx):
        hembed = discord.Embed(title="**Music Commands**", colour=discord.Color.dark_purple())
    ...
    async def levels(self, ctx):
        hembed = discord.Embed(title="**Level Commands**", colour=discord.Color.dark_purple())
